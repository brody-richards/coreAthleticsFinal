...
<head>
    ...
    <title>Admin Delete an Appointment Result | Core Athletics
    </title>
...
<div class="container">
    ...
    <?php
        ...
        $query1 = "SELECT * FROM appointment INNER JOIN athleteProfile ON appointment.userID = athleteProfile.id WHERE appointmentID = '$appointmentID'";
                ...
                while ($row1 = mysqli_fetch_array($sql1)) {
                    ...
                    echo "<p><span class='bold'>Client:</span> " . ucfirst($firstName) . " " . ucfirst($lastName) ."</p>";

                }

                ?>

                <a href="admindeleteconfirm.php" class="btn btn-danger btn-lg btn-block my-4">Confirm Deletion</a>
</div>
